      ...
      <div class="card-body info-table">
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">
            {{ balance | runebase }} RUNES
            <span v-if="unconfirmed !== '0' && staking !== '0'">
              ({{ unconfirmed | runebase }} RUNES {{ $t('address.unconfirmed') }},
              {{ staking | runebase }} RUNES {{ $t('address.staking') }})
            </span>
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">{{ totalReceived | runebase }} RUNES</div>
        </div>
        <div class="columns">
          <div class="column info-title">{{ $t('address.total_sent') }}</div>
          <div class="column info-value monospace">{{ totalSent | runebase }} RUNES</div>
        </div>
